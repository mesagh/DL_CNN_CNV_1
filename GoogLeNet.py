...
from keras.layers import Input, Dense, Convolution2D, MaxPooling2D, AveragePooling2D, ZeroPadding2D, Dropout, Flatten, \
    merge, Reshape, Activation, Conv2D, regularizers
...
def create_googlenet(weights_path=None):
    ...
    conv1_7x7_s2 = Conv2D(64, (7, 7), strides=(2, 2), padding="same", activation='relu', name='conv1/7x7_s2', kernel_regularizer=regularizers.l2(0.0002))(input)

    conv1_zero_pad = ZeroPadding2D(padding=(1, 1))(conv1_7x7_s2)

    pool1_helper = PoolHelper()(conv1_zero_pad)

    pool1_3x3_s2 = MaxPooling2D(padding="valid", strides=(2, 2), name="pool1/3x3_s2", pool_size=(3, 3))(pool1_helper)
